...
<template>
  ...
  >
    ...
    <UiIconButton
      ...
      aria-label="Alejar"
    >
      <svg viewBox="0 0 24 24" class="pointer-events-none h-[20px] w-[20px] fill-current text-slate-300" aria-hidden="true">
        <path
          fill="currentColor"
...
defineEmits(['set-mode', 'toggle-lock', 'toggle-snapping', 'fill-container', 'delete', 'zoom-in', 'zoom-out', 'reset-zoom'])
</script>
