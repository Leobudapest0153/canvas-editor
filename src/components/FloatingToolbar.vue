  ...
  >
    ...
    <div class="relative flex items-center rounded-full bg-gray-700/50 p-1">
      ...
      <button
        ...
        class="relative cursor-pointer z-10 flex h-10 w-10 items-center justify-center rounded-full transition-colors duration-200"
    ...
    <template v-if="isElementSelected">
      ...
      <button @click.stop="$emit('toggle-lock')"
        class="flex cursor-pointer h-12 w-12 items-center justify-center rounded-full transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-40"
