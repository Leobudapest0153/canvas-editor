...
export const useCanvasStore = defineStore('canvas', () => {
  ...
  if (typeof window !== 'undefined') {
    const saved = window.localStorage.getItem('useDragBoundsClamp')
    if (saved !== null) {
      useDragBoundsClamp.value = saved === 'true'
    }
    watch(useDragBoundsClamp, (val) => {
      window.localStorage.setItem('useDragBoundsClamp', String(val))
    })
  }
